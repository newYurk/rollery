...
// один и тот же runChecks(). Разница только в том, откуда его зовут.
//
...
//
// ЧТО ЭТО НЕ ЗАМЕНЯЕТ, И ЭТО ИЗМЕРЕНО. Браузерный ?check даёт «известно 22», терминальный —
// 26. Разница вся в проверках ВЁРСТКИ: ширину подписи здесь считает заглушка (7 px на символ),
// а не настоящий `ctx.measureText`, и раскладка на части размеров выходит другой. Числа про
// пиксели, цели касания и переносы читать отсюда НЕЛЬЗЯ — за ними идти в браузер.
//
