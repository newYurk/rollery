...
//
// ⚑ ДЕВЯТЬ → ПЯТНАДЦАТЬ (02.09, #158). Палитра упиралась не в решение, а в СПРАЙТЫ: видны были
...
// ⚑ ПОРЯДОК ЗДЕСЬ ЗНАЧИМ, ПОЭТОМУ МАССИВ, А НЕ МНОЖЕСТВО (02.09, #158). Прежде это был Set:
...
const ALL_INGREDIENTS = ['salmon', 'tuna', 'cucumber', 'tamago', 'avocado', 'shrimp', 'nori', 'mayo', 'eggsheet',
  ...
  // ⚑ КРАБ-ПАЛОЧКА И НАРУТО ВОЗВРАЩЕНЫ 02.09 (#158). Обе были в каталоге (`catalog.js`), обе
