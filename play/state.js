...
// ⚑ ПОЛЕ `spiral` — МОЖНО ЛИ ЭТУ ОБЁРТКУ КРУТИТЬ ВИТКАМИ (#111, заведено 02.09).
//
// Требование владельца дословно: «крутить так, как крутят мастера, и не наматывать нори
// спиралью — один раз и перехлестнулось на треть… нори — так не крутят». Разведка 01.09 по
// шести японским источникам не нашла ни одного случая нори витками; спираль крутят из
// 薄焼き卵 (伊達巻, 渦巻き寿司), из сурими (наруто) или из 油揚げ.
//
// ⚠ ЗАЧЕМ ПОЛЕ, А НЕ ПРОВЕРКА ИМЕНИ: 02.09 я включила переход кольцо→спираль (#141) для любой
// базы, и футомаки стал наматывать НОРИ спиралью. Владелец увидела это сразу — «что с нори?
// спирали не получилось по факту». В срезе действительно выходили рваные тёмные линии: нори
// 0,10 мм на двух витках не читается как спираль, а правило при этом нарушалось.
const WRAPPERS = {
  nori:  { name: 'Нори',            mm: 0.10, spiral: false, color: '#22342b', src: 'выведено: FAO даёт 21×19 см и ≈3 г → 75 г/м² ÷ ρ 0,7–1,0; толщину источник не называет (#107)' },
  rice:  { name: 'Рисовая бумага',  mm: 0.50, spiral: false, color: '#efe6d4', src: 'inferred' },
  soy:   { name: 'Соевая',          mm: 0.20, spiral: false, color: '#e3c069', src: 'inferred' },
  egg:   { name: 'Омлет',           mm: 1.50, spiral: true, color: '#e8b551', src: 'inferred (薄焼き卵)' },
  ...
  gyuhi: { name: 'Гюхи (моти)',     mm: 1.50, spiral: true, color: '#f7f0e6', src: 'inferred (求肥); источник подтверждает лист и заворачивание, миллиметров не даёт' },
};
