...
// ⚠ ЗДЕСЬ СТОЯЛО «ОТЛИЧИЕ ОТ АЛЬБОМА: в albumSave её нет, поэтому запись с блином вместо
// нори возвращается как нори». Это перестало быть правдой с правкой #86: albumSave пишет
// wrap (play/ui/album.js), и withRecipe его восстанавливает. Отличия больше нет — было
// описание расхождения, которого уже не существует, и оно противоречило шапке ЭТОГО ЖЕ
// файла, где формат альбома перечислен вместе с wrap. Найдено вечерней сверкой 31.08.
