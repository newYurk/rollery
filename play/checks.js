...
const REF = {
  ...
  //   hoso  ⌀29,1 · 1,15         ⌀32,7 · 1,32
  //   futo  ⌀54,7 · 1,14         ⌀62,5 · 1,36
  //   ura   ⌀33,0 · 1,09         ⌀38,6 · 1,13
  //   fruit ⌀53,3 · 1,14         ⌀62,0 · 1,35
  //
  ...
  hoso:  { d: 32.7, dmax: 33.5, turns: 1.32, core: true },
  futo:  { d: 62.5, dmax: 65.0, turns: 1.36, core: true },
  ura:   { d: 38.6, dmax: 38.7, turns: 1.13, core: true },
  fruit: { d: 62.0, dmax: 64.3, turns: 1.35, core: true },
};
...
function runChecks(detail) {
  ...
  try {
    ...
    // края в ядро не попадала, и центр выходил белым все 360°.
    {
      ...
      ok(spreadWhite5 <= 20, `#95: краска до конца листа, а в намотке белый рис — ${spreadWhite5} точек`);
      S.lists.futo = [];
    }
