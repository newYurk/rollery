  ...
  try {
    ...
    // спиралью, и что пустой лист не уезжает никуда.
    {
      const режимПри = (n, шаг) => {
        ...
        return getModel().g.winding;
      };
      ok(режимПри(0, 0) === 'ring', 'пустой лист уехал из кольца — обходить нечего, перехода быть не может');
      ok(режимПри(4, 0.06) === 'ring', 'компактная раскладка не осталась кольцом (#141)');
      ok(режимПри(7, 0.13) === 'spiral', 'начинка по всему листу не стала спиралью — кольцу нечем её обойти (#141)');
