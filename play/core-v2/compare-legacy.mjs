...
Длина листа и коробка ядра совпали побайтово в мм. Всё остальное разошлось, и
список собран из таблицы выше целиком, а не отобран на глаз:
${расходятся('F01')}.
...
- **Что разошлось** (из таблицы, целиком): ${расходятся('F02')}.
  ...
  Причина одна на всё. V2 кладёт рис кольцом вокруг СВОЕЙ коробки
