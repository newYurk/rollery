...
|---|---|---|---|
| лист и пустое ядро | ${сводка('F01', ТОЖДЕСТВО)} | ${сводка('F02', ТОЖДЕСТВО)} | якорь, не трогать |
| кольцо (нахлёст, ⌀, дуги) | ${сводка('F01', КОЛЬЦО)} | ${сводка('F02', КОЛЬЦО)} | не подгонять; \`kappa\` — отдельный ADR |
| начинка | ${сводка('F01', НАЧИНКА)} | ${сводка('F02', НАЧИНКА)} | V2 держит каталог и origin; не копировать семпл |
