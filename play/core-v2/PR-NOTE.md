...
## Divergence vs live geometry.js (ADR-001 step 5)

`docs/handoff/core-v2-geometry-divergence.md`. Regenerated by
`node play/core-v2/compare-legacy.mjs`. Sheet identity MATCH. Ring and filling
DIVERGE; do not fit. `kappa` is a later ADR.
