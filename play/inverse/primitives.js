...
//
// ЕДИНИЦЫ. Те же, что в модели: 1 единица = 5 мм. Миллиметры только на границе, через U_MM.
// Причина простая — в игре все размеры уже в этих единицах, и перевод внутри модуля был бы
// вторым местом, где легко ошибиться знаком или множителем.
//
...
const PRIM_U_MM = 5;                       // 1 единица модели = 5 мм
...
if (typeof module !== 'undefined' && module.exports)
  module.exports = { PRIM_U_MM, PRIM_TYPES, primHalfExtents, primBounds, primMinFeature, primBoxesOverlap, primValidate, primArea };
