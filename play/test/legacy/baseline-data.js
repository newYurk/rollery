...
//
// ⚠ Пересня́т ДЕСЯТЬ РАЗ за 01.09 (десятый и самый крупный — намотка стала КОЛЬЦОМ вместо
...
const ROLL_BASELINE = {
  ...
  "F03-wrapper-roundtrip": {
    ...
    "map": {
      ...
      "probe": "out,rice,rice,rice,rice,out,rice,rice,rice,wrap,out"
    },
    "selfSimilarity": 1
  },
  "F04-puzzle-recipe": {
    "turns": 1.2394,
    "outerDiameterMm": 71.9967,
    "closePoint": 65.0913,
    "sheetEnd": 73.1363,
    "sheetLength": 73.1363,
    "hasCore": true,
