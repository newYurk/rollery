...
//
// ⚠ Пересня́т ДЕВЯТЬ РАЗ за 01.09 (девятый — авокадо и лосось стали бруском 10×10 мм по
...
const ROLL_BASELINE = {
  ...
  "F02-futomaki-basic": {
    ...
    "map": {
      ...
      "probe": "out,rice,rice,rice,rice,rice,salmon,rice,rice,rice,out"
    },
    "selfSimilarity": 1
  },
  "F03-wrapper-roundtrip": {
    "turns": 1.1674,
    "outerDiameterMm": 69.2522,
    "closePoint": -1,
    "sheetEnd": 42,
    "sheetLength": 42,
    "hasCore": true,
