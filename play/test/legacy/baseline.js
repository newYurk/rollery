...
// ⚠ Здесь стояло «отличие: там НЕ восстанавливается S.wrap». С правкой #86 это неверно:
// withRecipe снимает и возвращает S.wrap наравне с остальным, и говорит об этом прямо.
// Отличия нет — оба пути ведут себя одинаково. Найдено вечерней сверкой 31.08.
