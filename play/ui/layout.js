...
// ПОДПИСЬ ЧИПА НЕ ШИРЕ СВОЕЙ ЯЧЕЙКИ (#158, 02.09).
//
...
function layout() {
  ...
  if (mode === 'L') {
    ...
    // ⚑ РЯД КНОПОК ИЗ СТОПКИ УБРАН (02.09, #158). Он стоил 56 px (44 + 12) и резервировался
    ...
    // ⚑ ПОТОЛОК РЯДОВ — ТРИ, А НЕ ДВА (02.09, #158). Двойка была зашита числом и при палитре
    ...
    // ⚑ ЦИНОВКА ЛЕЖИТ ПОД ЛИСТОМ, А НЕ ПОД РАМКОЙ (02.09, #158). Здесь стояло `L.sheet.y + sh`,
