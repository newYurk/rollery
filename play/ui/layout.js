...
// ⚠ ЗДЕСЬ СТОЯЛО ЧИСЛО 2 («обычный брусок — 2 единицы»), и оно уже разошлось с каталогом:
// 31.08 лосось стал 1,6 (был 2,0), а майо и вовсе 0,8. Пол считался по бруску, которого в
// палитре больше нет, и обещал цель касания на четверть больше настоящей. Найдено вечерней
// сверкой; тот же класс, что 0,048 в сторожe и s_fold в трёх файлах — величина модели,
// переписанная числом на стороне. Спрашиваем каталог.
