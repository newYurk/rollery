...
function layout() {
  ...
  if (mode === 'L') {
    ...
    L.chips = { x: ox + 12, y: L.handle.y + handleH + 12, w: stripW, size: chipSize, rows, labels: true, perRow, pad };
    ...
    L.layBtn = { x: L.rowBtn.x, y: L.chips.y + (rows - 1) * chipRow + (chipRow - btnH) / 2, w: L.rowBtn.w, h: btnH, max: 3 };
