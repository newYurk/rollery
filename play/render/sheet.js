...
// точек экрана, в 2·DPR раз крупнее риса. Замер на футомаки (390×844, DPR 2): брусок лосося
// 10 мм = 19 css px укладывался в 2 клетки поперёк, огурец 14 мм — в 3. Никакой фактуры в двух
// клетках не бывает, и порог `есть_грани >= 6` ниже не срабатывал вообще ни на одном куске.
// Теперь клетка куска = PIX/2 точек экрана: ровно вдвое мельче риса при ЛЮБОМ DPR (2 css px
// при DPR 2 — то самое число, под которое сняты спрайты). Поперёк стало 10 и 13 клеток.
