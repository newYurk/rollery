...
Y_FRONT_MIN = 0.30       # lower FRONT end of the arc never goes below this absolute height (T), as
                         # KINEMATICS.md asks. With --lift 1 the circle's own bottom already sits at the
                         # top of the incoming sheet (1.12 T), so the mat cannot scrape the rice bed.
