...
TITLES = {
    'reference':   ('★ Эталон — по нему сверяется игра',
                    'Циновка ПОД листом и заворачивается вместе с роллом, пальцы держат начинку. '
                    'Пять контрольных раскладок. Именно с этим сверяются диаметры и витки в игре'),
