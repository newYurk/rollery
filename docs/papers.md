...
| сайт | чем полезен |
|---|---|
| [SUZUMO](https://www.suzumo.co.jp/) | спецификации машин формовки: **толщина и длина рисового пласта** — 7×80 и 12×160 мм |
| [Google Patents](https://patents.google.com/) | патенты на суши-роботы: механика прижима и намотки |
...
сжатие начинки · ориентация асимметричного куска. **Ни по одному пункту искать больше негде** —
если число понадобится, оно будет игровой условностью и обязано быть так помечено.
