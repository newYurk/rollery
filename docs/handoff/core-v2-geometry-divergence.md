...
|---|---|---|---|
| лист и пустое ядро | MATCH | DIVERGE 2 из 5: до 6.000 мм (ядро Wc) | якорь, не трогать |
| кольцо (нахлёст, ⌀, дуги) | DIVERGE 7 из 7: до 31.487 мм (дуга риса (пространственная)); до 40.000 шт (лучи с двумя слоями нори) | DIVERGE 6 из 7: до 18.914 мм (дуга риса (пространственная)); до 57.000 шт (лучи с двумя слоями нори) | не подгонять; `kappa` — отдельный ADR |
| начинка | — | DIVERGE 3 из 3: до 7.663 мм² (площадь огурца); до 1.314 мм (центр огурца X) | V2 держит каталог и origin; не копировать семпл |
